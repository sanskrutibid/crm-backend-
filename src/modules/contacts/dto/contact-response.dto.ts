...
export class ContactResponseDto {
  @ApiProperty({ example: '60d5ed7ab394142e88a38c29', description: 'Contact unique database ID' })
  id: string;
  ...
  @ApiProperty({ example: 'Customer', description: 'Customer type classification' })
  customerType: string;

  @ApiProperty({ example: 'Employee', description: 'Contact type classification' })
  contactType: string;

  @ApiProperty({ example: '+91 9876543210', description: 'Primary contact phone' })
  mobile: string;

  @ApiProperty({ example: 'Pending', enum: DNDStatus, description: 'DND registry registration status' })
  dndStatus: DNDStatus;

  @ApiPropertyOptional({ example: '+91 8765432109', description: 'Alternative contact phone numbers' })
  otherNumbers?: string;

  @ApiPropertyOptional({ example: 'dayamati@gmail.com', description: 'Primary contact email' })
  email?: string;

  @ApiProperty({ example: 'Pending', enum: EmailStatus, description: 'Email security verification status' })
  ...
  @ApiPropertyOptional({ example: '32104598734', description: 'Bank account number value' })
  ...
  @ApiProperty({ example: true, description: 'Toggle automatic birthday greetings' })
  ...
  @ApiPropertyOptional({ example: 4.50, description: 'Customer priority rating ratio' })
  rating?: number;
  ...
  @ApiProperty({ description: 'CRM agent assigned to this contact', type: AuthUserDto })
  ...
  @ApiProperty({ example: 'Private', enum: ContactVisibility, description: 'Visibility scope permissions' })
  visibility: ContactVisibility;

  @ApiProperty({ example: false, description: 'Marks phone number confidential' })
  isConfidential: boolean;

  @ApiProperty({ example: true, description: 'Opt-in for marketing emails & sms campaigns' })
  subscribePromotions: boolean;

  // ==========================================
  // Timestamps / Audit Traces (Screenshot 6)
  // ==========================================
  @ApiProperty({ example: '2026-05-26T14:04:03.000Z', description: 'Timestamp of contact registration' })
  createdAt: string;
