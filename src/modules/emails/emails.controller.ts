import { Controller, Post, Get, Body, Param, Query, Req, Res } from '@nestjs/common';
...
export class EmailsController {
  ...
  @Get('reports')
  @ApiOperation({ summary: 'List and filter scheduled/sent email reports with search, sorting, and pagination' })
  ...
  @ApiOkResponse({ description: 'Email report details retrieved successfully.' })
  ...
  @Get('track/:id')
  @ApiOperation({ summary: 'Track email open via 1x1 transparent tracking pixel' })
  async trackOpen(
    @Param('id') id: string,
    @Req() req: any,
    @Res() res: any,
