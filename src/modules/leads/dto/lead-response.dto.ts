...
export class LeadResponseDto {
  @ApiProperty({
    ...
    description: 'Lead unique database ID',
  })
  id: string;
  ...
  // ==========================================
  @ApiProperty({
    description: 'Contact profile associated with this lead',
  ...
  @ApiProperty({
    ...
    description: 'Lead basic requirement details',
  })
  requirement: string;

  @ApiProperty({
    example: 'Client seems highly interested, scheduled site visit.',
    description: 'Initial followup notes',
  })
  followupNote: string;

  @ApiProperty({
    example: '26-May-2026',
    description: 'Followup scheduled date (YYYY-MM-DD)',
  })
  scheduleDate: string;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Property specification keywords/tags',
  })
  keywords?: string;
  ...
  @ApiProperty({
    example: 'Global Team',
    description: 'Assigned CRM office branch location',
  })
  branch: string;

  @ApiProperty({
    description: 'CRM executive assigned to this lead',
    type: AuthUserDto,
  })
  ...
  @ApiProperty({
    example: false,
    description: 'WhatsApp alert notification to assignee',
  })
  sendWhatsAppToAssignee: boolean;

  @ApiProperty({
    example: false,
    description: 'Email alert notification to assignee',
  })
  sendEmailToAssignee: boolean;

  @ApiProperty({
    example: false,
    description: 'WhatsApp confirmation notification to customer',
  })
  sendWhatsAppToCustomer: boolean;

  @ApiProperty({
    example: false,
    description: 'Email confirmation notification to customer',
  })
  ...
  @ApiProperty({
    example: false,
    description: 'Terms and conditions shared confirmation status',
  })
  termsShared: boolean;
  ...
  @ApiProperty({
    ...
    description: 'Urgency temperature badge classification',
  })
  ...
  @ApiPropertyOptional({
    ...
    description: 'Follow-up outcome remark details',
  })
  outcome?: string;

  @ApiPropertyOptional({
    example: 'Rs. 1.38 Crore, 3 Bed, for Sale in Riddhi Siddhi, Pande Layout',
    description: 'Interested target property description',
  })
  interestedIn?: string;

  @ApiPropertyOptional({
    example: 'Follow-Up Scheduled',
    description: 'Schedule execution purpose',
  })
  purpose?: string;

  @ApiProperty({
    example: '2026-05-26T14:04:03.000Z',
    description: 'Timestamp of lead assignment',
  })
  assignDate: string;

  @ApiPropertyOptional({
    description: 'User profile who registered this lead',
    type: AuthUserDto,
  })
  createdBy?: AuthUserDto;

  @ApiPropertyOptional({
    description: 'User profile who last updated this lead',
    type: AuthUserDto,
  })
  ...
  @ApiProperty({
    example: '2026-05-26T14:04:03.000Z',
    description: 'Timestamp of lead registration',
  })
  createdAt: string;
