...
export class QueryOpportunityDto {
  @ApiPropertyOptional({
    ...
    description:
      "Filter listings by custom view categories: 'today' (Todays follow-up), 'open' (Active Opportunities), 'all' (All Opportunities), 'backlog' (Outstanding/Missed follow-ups in the past), 'pending' (Awaiting follow-up), 'calendar' (Scheduled dates feed).",
    default: 'all',
  })
  @IsEnum(['today', 'open', 'all', 'backlog', 'pending', 'calendar'], {
    message: 'Invalid opportunity view type',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 'Chirag',
    description:
      'Search string matching customer name, phone, email, or requirement details',
  })
  @IsString()
  @IsOptional()
  search?: string;
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Sync Parameter: Fetch only opportunity records created or modified since this timestamp.',
  })
  @IsString()
  @IsOptional()
  updatedSince?: string;
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Field to sort opportunities by (Assigned Date, Create Date, FollowUp Date, Updated Date, Name)',
    default: 'Create Date',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: '60d5ecb8b394142e88a38c21',
    description: 'Filter by User ID who submitted the opportunity',
  })
  @IsString()
  @IsOptional()
  submittedBy?: string;
  ...
  @ApiPropertyOptional({
    example: 'Buy',
    description: 'Filter by Opportunity purpose/preferences classification',
  })
  @IsString()
  @IsOptional()
  purpose?: string;
  ...
  @ApiPropertyOptional({
    example: 'In Progress',
    description: 'Filter by Opportunity Status classification',
  })
  @IsString()
  @IsOptional()
  status?: string;
